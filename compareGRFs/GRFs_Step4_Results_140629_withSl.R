...
StanceSummaryStats <- data.frame(sort(unique(StanceDurationData$Group)), Stance.Means, Stance.SE)
names(StanceSummaryStats) <- c("group", "mean", "se")

LimbStanceDurationData <- data.frame(rbind(Pec.Af.Kept.VideoInfo, Pel.Af.Kept.VideoInfo, Pec.Pw.Kept.VideoInfo, Pel.Pw.Kept.VideoInfo)) 

for (i in 1:nrow(LimbStanceDurationData)) {
  ifelse(LimbStanceDurationData$Appendages[[i]]==unique("Pelvic"), LimbStanceDurationData$Stance[[i]] <- LimbStanceDurationData$Pelvic.End.Frame[[i]]-LimbStanceDurationData$Pelvic.Start.Frame[[i]],
         LimbStanceDurationData$Stance[[i]] <- LimbStanceDurationData$Pectoral.End.Frame[[i]]-LimbStanceDurationData$Pectoral.Start.Frame[[i]])
  
}
LimbStance.LMER <- lmer(Stance~Group+(1|Ind), LimbStanceDurationData, verbose=T, REML=F)
LimbStance.LMER.Null <- lmer(Stance~1+(1|Ind), LimbStanceDurationData, REML=F)
# Likelihood ratio tests cannot take REML products; it will autotmatically convert it to Maximum Likehood before analysis
LimbStance.LMER.Compare <- anova(LimbStance.LMER, LimbStance.LMER.Null)
LimbStance.Tukey <- lsmeans(LimbStance.LMER, pairwise~as.factor(Group), adjust="tukey")
...
ggplot(data=InterpML.Mean.SE, aes(x=InterpML.Mean.SE$Stance, y=InterpML.Mean.SE$Mean, fill=Type, linetype=Type))+
  ...
  scale_colour_manual(name="Appendage:",
    labels=c("Aquatic FL  ", "Semi-aquatic FL    ", "Semi-aquatic HL    ", "Terrestrial FL    ", "Terrestrial HL  ", "Terrestrial PF  "),
    values=c("ivory4", "ivory4", "ivory4", "ivory4", "ivory4"))+
  #scale_fill_manual(values=c("ivory4", "ivory4", "ivory4"))+
  scale_fill_manual(name="Appendage:", 
                    labels=c("Aquatic FL  ", "Semi-aquatic FL    ", "Semi-aquatic HL    ", "Terrestrial FL    ", "Terrestrial HL  ", "Terrestrial PF  "),
                    #values=c("ivory4", "ivory4", "ivory4"))+
                    values=c("purple", "lightblue3", "steelblue3", "burlywood", "rosybrown4", "seagreen"))+
  scale_linetype_manual(name="Appendage:",
    labels=c("Aquatic FL  ", "Semi-aquatic FL    ", "Semi-aquatic HL    ", "Terrestrial FL    ", "Terrestrial HL  ", "Terrestrial PF  "),
    values=c("dashed", "dashed", "dotted", "dashed", "dotted", "solid"))+
  theme(axis.title.x=element_text(colour="black", size=30))+ # vjust=0 puts a little more spacing btwn the axis text and label
  theme(axis.title.y=element_text(colour='black', size=30))+
  theme(axis.text.x=element_text(colour='black', size=15))+
  theme(axis.text.y=element_text(colour='black', size=15))+
  ...
  theme(panel.background=element_blank())+ # make background white
  theme(axis.line=element_line(colour="black", linetype="solid"))+ # put black lines for axes
  theme(legend.position="bottom", legend.key.size= unit(15, "mm"), legend.text=element_text(size=13))
dev.off()
...
#                     values=c("ivory4", "ivory4", "ivory4", "ivory4", "ivory4"))+
  ...
  theme(panel.background=element_blank())+ # make background white
  theme(axis.line=element_line(colour="black", linetype="solid"))+ # put black lines for axes
  theme(legend.position="bottom", legend.position="horizontal", legend.key.size= unit(15, "mm"), legend.text=element_text(size=13))
dev.off()
...
ggplot(data=NetGRF.Mean.SE, aes(x=NetGRF.Mean.SE$Stance, y=NetGRF.Mean.SE$Mean, fill=Type, linetype=Type))+
  ...
  scale_colour_manual(name="Appendage:", 
                      labels=c("Aquatic FL  ", "Semi-aquatic FL  ", "Semi-aquatic HL  ", "Terrestrial FL  ", "Terrestrial HL  ", "Terrestrial PF  "),
                      values=c("ivory4", "ivory4", "ivory4", "ivory4", "ivory4", "ivory4"))+
#   scale_fill_manual(name="Appendage:", 
...
#                     values=c("ivory4", "ivory4", "ivory4"))+
  ...
  theme(panel.background=element_blank())+ # make background white
  theme(axis.line=element_line(colour="black", linetype="solid"))+ # put black lines for axes
  theme(legend.position="bottom",  legend.direction="horizontal", legend.key.size= unit(15, "mm"), legend.text=element_text(size=13))
dev.off()
...
APAngle.Plot <- ggplot(data=APAngle.Mean.SE, aes(x=APAngle.Mean.SE$Stance, y=APAngle.Mean.SE$Mean, fill=Type, linetype=Type))+
  ...
  scale_colour_manual(values=c("ivory4", "ivory4", "ivory4", "ivory4", "ivory4"))+
  #scale_fill_manual(values=c("ivory4", "ivory4", "ivory4"))+
  scale_fill_manual(values=c("lightblue3", "steelblue3", "burlywood", "rosybrown4", "seagreen"))+ # make sure types are alphabetically arranged
  scale_linetype_manual(values=c("dashed", "dotted", "dashed", "dotted", "solid"))+

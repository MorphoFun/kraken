...
#' P1 <- matrix(c(0.001005251, 0.001195392, 0.001406054, -0.09343679, -0.09347614, -0.09350069, 0.01603717, 0.0161097, 0.01616693), 3, 3, byrow = TRUE)
#' P2 <- matrix(c(0.006305306, 0.006526961, 0.006747555. -0.08206114, -0.08207707, -0.08207049, 0.006997669, 0.006980824, 0.006975157), 3, 3, byrow = TRUE)
#' 
